#!/usr/bin/env python
"""Standalone reproducer: C sp³ nanocrystalline → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python carbon_sp3_nc_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 18.0, 'displacement_sigma': 0.02, 'w_graphite': 0.0, 'w_diamond': 1.0, 'bond_weight': 2.5, 'angle_weight': 1.2, 'repulsion_weight': 2.0, 'hard_core_scale': 0.92, 'nonbond_push_scale': 0.85}
VIZ = {'tetrahedra': {'center_symbol': 'C', 'vertex_symbol': 'C', 'bond_length': 1.54, 'bond_length_tol': 0.1, 'angle_tol_deg': 15.0}, 'tetrahedra_color': (0.25, 0.35, 0.85), 'tetrahedra_opacity': 0.45}
TITLE = 'C sp³ nanocrystalline'
OUT_PREFIX = "carbon_sp3_nc"
STEPS = 50
