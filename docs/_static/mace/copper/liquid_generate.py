#!/usr/bin/env python
"""Standalone reproducer: Cu Liquid → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python copper_liquid_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': None, 'displacement_sigma': 0.03, 'bond_weight': 3.0, 'angle_weight': 0.0, 'repulsion_weight': 1.5, 'hard_core_scale': 0.95, 'nonbond_push_scale': 1.0, 'mace_mode': 'md'}
VIZ = {'cuboctahedra': {'center_symbol': 'Cu', 'vertex_symbol': 'Cu'}, 'cuboctahedra_color': (0.85, 0.45, 0.2), 'cuboctahedra_opacity': 0.22}
TITLE = 'Cu Liquid'
OUT_PREFIX = "copper_liquid"
STEPS = 50
