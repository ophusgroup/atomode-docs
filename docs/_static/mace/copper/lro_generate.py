#!/usr/bin/env python
"""Standalone reproducer: Cu LRO → orient → MACE+wall → movies.
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 26.0, 'displacement_sigma': 0.02, 'bond_weight': 4.5, 'angle_weight': 0.0, 'repulsion_weight': 1.9, 'hard_core_scale': 0.99, 'nonbond_push_scale': 1.0}
VIZ = {'cuboctahedra': {'center_symbol': 'Cu', 'vertex_symbol': 'Cu'}, 'cuboctahedra_color': (0.85, 0.45, 0.2), 'cuboctahedra_opacity': 0.22}
TITLE = 'Cu LRO'
OUT_PREFIX = "copper_lro"
STEPS = 50
