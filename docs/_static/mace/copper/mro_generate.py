#!/usr/bin/env python
"""Standalone reproducer: Cu MRO → orient → MACE+wall → movies.
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 18.0, 'displacement_sigma': 0.025, 'bond_weight': 4.0, 'angle_weight': 0.0, 'repulsion_weight': 1.7, 'hard_core_scale': 0.97, 'nonbond_push_scale': 1.0}
VIZ = {'cuboctahedra': {'center_symbol': 'Cu', 'vertex_symbol': 'Cu'}, 'cuboctahedra_color': (0.85, 0.45, 0.2), 'cuboctahedra_opacity': 0.22}
TITLE = 'Cu MRO'
OUT_PREFIX = "copper_mro"
STEPS = 50
