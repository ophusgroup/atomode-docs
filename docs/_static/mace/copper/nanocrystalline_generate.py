#!/usr/bin/env python
"""Standalone reproducer: Cu Nanocrystalline → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python copper_nanocrystalline_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 35.0, 'displacement_sigma': 0.01, 'bond_weight': 5.0, 'angle_weight': 0.0, 'repulsion_weight': 2.0, 'hard_core_scale': 1.0, 'nonbond_push_scale': 1.0}
VIZ = {'cuboctahedra': {'center_symbol': 'Cu', 'vertex_symbol': 'Cu'}, 'cuboctahedra_color': (0.85, 0.45, 0.2), 'cuboctahedra_opacity': 0.22}
TITLE = 'Cu Nanocrystalline'
OUT_PREFIX = "copper_nanocrystalline"
STEPS = 50
