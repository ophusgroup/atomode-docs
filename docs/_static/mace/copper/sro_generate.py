#!/usr/bin/env python
"""Standalone reproducer: Cu SRO → orient → MACE+wall → movies.
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 12.0, 'displacement_sigma': 0.03, 'bond_weight': 3.5, 'angle_weight': 0.0, 'repulsion_weight': 1.6, 'hard_core_scale': 0.96, 'nonbond_push_scale': 1.0}
VIZ = {'cuboctahedra': {'center_symbol': 'Cu', 'vertex_symbol': 'Cu'}, 'cuboctahedra_color': (0.85, 0.45, 0.2), 'cuboctahedra_opacity': 0.22}
TITLE = 'Cu SRO'
OUT_PREFIX = "copper_sro"
STEPS = 50
