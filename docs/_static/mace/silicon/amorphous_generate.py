#!/usr/bin/env python
"""Standalone reproducer: Si amorphous → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python silicon_amorphous_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': None, 'displacement_sigma': 0.12, 'bond_weight': 0.6, 'angle_weight': 0.2, 'repulsion_weight': 1.3, 'hard_core_scale': 0.86, 'nonbond_push_scale': 0.45}
