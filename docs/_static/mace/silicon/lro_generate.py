#!/usr/bin/env python
"""Standalone reproducer: Si LRO → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python silicon_lro_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 15.0, 'displacement_sigma': 0.035, 'bond_weight': 2.4, 'angle_weight': 1.0, 'repulsion_weight': 2.3, 'hard_core_scale': 0.93, 'nonbond_push_scale': 0.85}
