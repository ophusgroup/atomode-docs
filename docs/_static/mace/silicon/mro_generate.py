#!/usr/bin/env python
"""Standalone reproducer: Si MRO → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python silicon_mro_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 12.0, 'displacement_sigma': 0.04, 'bond_weight': 2.0, 'angle_weight': 0.8, 'repulsion_weight': 2.2, 'hard_core_scale': 0.93, 'nonbond_push_scale': 0.75}
