#!/usr/bin/env python
"""Standalone reproducer: Si Nanocrystalline → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python silicon_nanocrystalline_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 20.0, 'displacement_sigma': 0.02, 'bond_weight': 2.4, 'angle_weight': 1.0, 'repulsion_weight': 2.3, 'hard_core_scale': 0.95, 'nonbond_push_scale': 0.9}
VIZ = {'tetrahedra': {'center_symbol': 'Si', 'vertex_symbol': 'Si', 'bond_length_tol': 0.1, 'angle_tol_deg': 18.0}, 'tetrahedra_color': (0.35, 0.45, 0.95), 'tetrahedra_opacity': 0.45}
TITLE = 'Si Nanocrystalline'
OUT_PREFIX = "silicon_nanocrystalline"
STEPS = 50
