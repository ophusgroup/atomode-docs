#!/usr/bin/env python
"""Standalone reproducer: Si sro → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python silicon_sro_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 8.0, 'displacement_sigma': 0.06, 'bond_weight': 1.5, 'angle_weight': 0.5, 'repulsion_weight': 1.8, 'hard_core_scale': 0.91, 'nonbond_push_scale': 0.6}
