#!/usr/bin/env python
"""Standalone reproducer: SiO₂ liquid → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python silicon_dioxide_liquid_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': None, 'displacement_sigma': 0.012, 'bond_weight': 1.55, 'angle_weight': 1.25, 'repulsion_weight': 1.25, 'hard_core_scale': 0.81, 'nonbond_push_scale': 0.7, 'mace_mode': 'md'}
VIZ = {'tetrahedra': {'center_symbol': 'Si', 'vertex_symbol': 'O'}, 'tetrahedra_color': (0.28, 0.62, 0.95), 'tetrahedra_opacity': 0.42}
TITLE = 'SiO₂ liquid'
OUT_PREFIX = "silicon_dioxide_liquid"
STEPS = 50
