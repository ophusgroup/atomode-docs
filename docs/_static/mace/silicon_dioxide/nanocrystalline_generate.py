#!/usr/bin/env python
"""Standalone reproducer: SiO₂ Nanocrystalline → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python silicon_dioxide_nanocrystalline_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 35.0, 'displacement_sigma': 0.003, 'bond_weight': 1.65, 'angle_weight': 1.35, 'repulsion_weight': 1.3, 'hard_core_scale': 0.82, 'nonbond_push_scale': 0.72}
VIZ = {'tetrahedra': {'center_symbol': 'Si', 'vertex_symbol': 'O'}, 'tetrahedra_color': (0.28, 0.62, 0.95), 'tetrahedra_opacity': 0.42}
TITLE = 'SiO₂ Nanocrystalline'
OUT_PREFIX = "silicon_dioxide_nanocrystalline"
STEPS = 50
