#!/usr/bin/env python
"""Standalone reproducer: SrTiO₃ Liquid → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python strontium_titanate_liquid_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': None, 'displacement_sigma': 0.008, 'bond_weight': 0.5, 'angle_weight': 0.4, 'repulsion_weight': 1.1, 'hard_core_scale': 1.1, 'nonbond_push_scale': 0.65, 'mace_mode': 'md'}
VIZ = {'octahedra': {'center_symbol': 'Ti', 'vertex_symbol': 'O'}, 'octahedra_color': (0.95, 0.55, 0.25), 'octahedra_opacity': 0.42}
TITLE = 'SrTiO₃ Liquid'
OUT_PREFIX = "strontium_titanate_liquid"
STEPS = 50
