#!/usr/bin/env python
"""Standalone reproducer: SrTiO₃ LRO → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python strontium_titanate_lro_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 28.0, 'displacement_sigma': 0.0015, 'bond_weight': 1.0, 'angle_weight': 0.7, 'repulsion_weight': 1.2, 'hard_core_scale': 1.1, 'nonbond_push_scale': 0.75}
VIZ = {'octahedra': {'center_symbol': 'Ti', 'vertex_symbol': 'O'}, 'octahedra_color': (0.95, 0.55, 0.25), 'octahedra_opacity': 0.42}
TITLE = 'SrTiO₃ LRO'
OUT_PREFIX = "strontium_titanate_lro"
STEPS = 50
