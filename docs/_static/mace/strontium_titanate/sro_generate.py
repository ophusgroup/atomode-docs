#!/usr/bin/env python
"""Standalone reproducer: SrTiO₃ SRO → orient → MACE+wall → movies.
...
docs/structures/ directory — run from there or edit the path.
    python strontium_titanate_sro_generate.py
"""
import numpy as np
...
BOX = 40.0
RNG_SEED = 2026
KW = {'grain_size': 14.0, 'displacement_sigma': 0.005, 'bond_weight': 1.0, 'angle_weight': 0.7, 'repulsion_weight': 1.2, 'hard_core_scale': 1.1, 'nonbond_push_scale': 0.75}
VIZ = {'octahedra': {'center_symbol': 'Ti', 'vertex_symbol': 'O'}, 'octahedra_color': (0.95, 0.55, 0.25), 'octahedra_opacity': 0.42}
TITLE = 'SrTiO₃ SRO'
OUT_PREFIX = "strontium_titanate_sro"
STEPS = 50
