...
{meth}`tricor.Supercell.generate` /
{meth}`tricor.Supercell.shell_relax`.
...
.. autoclass:: CoordinationShellTarget
   ...
   .. automethod:: from_targets

   .. rubric:: Modifiers
   .. automethod:: with_cross_species_bonds_only
   .. automethod:: with_bonded_species_pairs
   .. automethod:: with_angle_triplets
   .. automethod:: without_angle_triplets

   .. rubric:: Helpers
   .. autoproperty:: pair_labels
   .. autoproperty:: angle_labels
```
