...
:::{iframe} https://ophusgroup.github.io/atomode-docs/viewers/fire/copper/liquid_fire_movie.html
:width: 100%
:::
...
:::{iframe} https://ophusgroup.github.io/atomode-docs/viewers/fire/copper/liquid_g3_fire.html
:width: 100%
:::

## Bond length and angle distributions

```{image} ../../figures/fire/copper/liquid_bond_hist.png
:alt: Copper Liquid bond length distribution
:width: 100%
```

```{image} ../../figures/fire/copper/liquid_angle_hist.png
:alt: Copper Liquid angle distributions
:width: 100%
```

```{image} ../../figures/fire/copper/liquid_gr.png
