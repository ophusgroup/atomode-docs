...
atomode-generated supercells relaxed with the built-in [FIRE spring network](../algorithms/fire_relaxation.md).  FIRE is orders of magnitude faster than [MACE-MP0 refinement](../examples_mace/index.md) at lower accuracy, and is the practical option for cells of 100³ Å and larger (see [cost and convergence](../algorithms/fire_relaxation.md#cost-and-convergence)).  Each final structure is scored with a MACE-MP0 single point, so the FIRE and MACE pipelines can be compared directly.
